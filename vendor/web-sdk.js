...
! function(e, t) {
    ...
    return function(e) {
        ...
        (function(t, i, o, r, s, a) {
            e.exports = function() {
                function e(e) {
                    if (pe || me) ne(new Error("Zendesk Chat Web SDK has already been initialized. Please ensure that zChat.init() is only called once in your code"));
                    else {
                        var t = Ne.obj({
                ...
                function w() {
                    var e = me.$("livechat").$("profile").$("department_id$int"),
                        t = e.getValue();
                    return i(t) ? t : void 0;
                }

                function b(e, t) {
                    var n = "setVisitorDefaultDepartment()",
                        i = Ne.type("number").chain(re);
                    if (!ie([i, je], [e, t], n)) {
                        t = t || Le;
                ...
                function x() {
                    var e = me.$("livechat").$("channel").$("rating$string").getValue(),
                        t = me.$("livechat").$("channel").$("comment$string").getValue(),
                        n = {};
                    o(e) || (n.rating = e);
                    o(t) || (n.comment = t);
                    return n;
                ...
                function A(e, t) {
                    var n = "sendChatRating()",
                        i = Ne.any([Ne.equal(null), Ne.equal("good"), Ne.equal("bad")]);
                    if (!ie([i, je], [e, t], n)) {
                        t = t || Le;
                ...
                function M(e, t) {
                    var n = "sendEmailTranscript()",
                        i = Ne.type("string").regex(Ae.email);
                    if (!ie([i, je], [e, t], n)) {
                        t = t || Le;
                        pe.$("livechat").$("channel").write({
                ...
                function z() {
                    var e, t, n, i = ["type$string", "timestamp$int"],
                        o = me.$("livechat").$("channel").$("log").getValue(),
                        r = [];
                    for (var s in o)
                ...
                function he() {
                    var e = me.$("livechat").$("settings"),
                        t = e.getValue(),
                        n = we.clone(Ce.livechat.settings),
                        i = xe.fullyExtend(n, t),
                        o = Ye(i);
                    return te(o);
                }
                var de, pe, me, ge, _e, ve, we = n(10),
                    be = n(11),
                    ye = n(12),
                    $e = n(14),
                    Ee = n(61),
                    ...
                    Me = /^(https?|ftps?):\/\//i,
                    Pe = /\S/,
                    je = Ne.any([Ne.equal(void 0), Ne.type("function")]),
                    Ue = {
                    ...
                    Fe = Y(Ue),
                    ze = Y(Ve),
                    qe = W(["email$string", "phone$string", "display_name$string"]),
                    Be = W(["name$string", "status$string"], "id", P),
                    We = W(["avatar_path$string", "display_name$string", "title$string"], "nick"),
                    Ge = W(["typing$bool"], "nick", j),
                    He = W(["typing$bool"], "display_name", U),
                    Ke = W(["timestamp$int"], null, F),
                    Ye = W(["banner", "behavior", "bubble", "chat_button", "chat_window", "concierge", "file_sending", "forms", "greetings", "language", "login", "rating", "sound", "theme", "timezone$string"]);
        ...
        (function(t, n) {
            e.exports = function() {
                ...
                function l() {
                    ...
                    else if (document.addEventListener) /loaded|complete/i.test(document.readyState) ? u() : document.addEventListener("DOMContentLoaded", u, !1);
                    else if (t.isIE) {
            ...
            module.exports = function() {
                function sniffBrowser() {
                    ...
                    var nav = navigator,
                        ...
                        isNewIE = +(/trident.*rv:? *([0-9]+)/.exec(ua) || [])[1] || !1,
                        isIE = checkIE(),
                        isIE8 = 8 === isIE,
                        isIE7 = 7 === isIE,
                        isIE6 = 6 === isIE,
                        isOpera = !!window.opera && "[object Opera]" === Object.prototype.toString.call(window.opera),
                        isEdge = ua.indexOf("edge") > -1,
                        isChrome = "Google Inc." === nav.vendor,
                        isSafari = "Apple Computer, Inc." === nav.vendor,
                        isWebKit = !isEdge && !isIE && !isOpera && (isChrome || isSafari || /webkit|khtml/.test(ua)),
                        isFF = +/\d+/.exec(/firefox\/\d+/i.exec(nav.userAgent) || ""),
                        isIPhone = ua.indexOf("iphone") !== -1,
                        isIPod = ua.indexOf("ipod") !== -1,
                        isIPad = ua.indexOf("ipad") !== -1,
                        isIOS = isIPhone || isIPad || isIPod,
                        isAndroid = ua.indexOf("android") !== -1,
                        isWP7 = ua.indexOf("wp7") !== -1,
                        isMobile = isIOS || isAndroid || isWP7,
                        scrollbar_size, browser = isIE && "msie" || isFF && "firefox" || isOpera && "opera" || isChrome && "chrome" || isSafari && "safari",
                        version, isStrict = "CSS1Compat" === document.compatMode,
                        isQuirks = !isStrict,
                        isIE5Quirks = isIE && isQuirks && document.documentElement && !!document.documentElement.style.setExpression,
                        engineIE = document.documentMode || isIE,
                        isWindows = ua.indexOf("windows") !== -1 || ua.indexOf("win32") !== -1,
                        isMac = ua.indexOf("macintosh") !== -1 || ua.indexOf("mac os x") !== -1,
                        isSecure = "https:" === document.location.protocol,
                        language = nav.language || nav.browserLanguage || nav.userLanguage || nav.systemLanguage,
                        bugs = {
                        ...
                        isTextContent = "textContent" in document.createElement("div"),
                        isCustomEvents = !1,
                        CustomEvent = null;
                    try {
        ...
        (function(t, i, o, r, s) {
            e.exports = function() {
                function e(e) {
                    ...
                    if (H) W.$("status$string").update("reattached");
                    else {
                ...
                function a(e) {
                    ...
                    if ("idle_disconnect" == e || "shutdown" == e || "error" == e) {
                        var t = B.$("livechat").$("account").$("status$string").getValue(),
                            n = B.$("connection").$("backoff"),
                ...
                function O() {
                    if (ce.ACCOUNT_KEY) {
                        G || Oe.connect();
                        var e = ue.getIdentity(),
                            t = ne(),
                            n = B.$("livechat").$("ui").getValue("mobile$bool") ? "mobile" : "desktop",
                            o = B.$("livechat").$("settings").$("theme").getValue("name$string"),
                            r = {
                                __type: "register",
                        ...
                        if (B.$("livechat").$("ui").$("popout$bool").getValue()) r.popout = !0;
                        else {
                ...
                function I() {
                    var e = W.getValue("status$string"),
                        t = W.getValue("socket_status$string");
                    window.clearTimeout(D.timer);
                    if ("error" != e)
                        if ("break" == t)
                            if ("idle_disconnect" == e) W.update({
                ...
                var z, q, B, W, G, H, K, Y, X, J, Z, Q, ee, te, ne, ie, oe, re, se, ae, ce = n(12),
                    ue = n(15),
                    le = n(29),
                    fe = n(22),
                    he = n(50),
            ...
            e.exports = function() {
                ...
                e.buildQuery = function(e) {
                    ...
                    for (n = 0, o = c.length; n < o; n++) {
                        ...
                        if (t(a))
                            if (1 !== a.length || a[0] !== !0)
                                for (i = 0, r = a.length; i < r; i++) u.push(s + "=" + window.encodeURIComponent(a[i] + ""));
                            else u.push(s);
        ...
        (function(t, n, i) {
            e.exports = function() {
                ...
                var c = !t(window) && window.JSON || {
                    ...
                    f = "(?:-?\\b(?:0|[1-9][0-9]*)(?:\\.[0-9]+)?(?:[eE][+-]?[0-9]+)?\\b)",
                    h = '(?:[^\\0-\\x08\\x0a-\\x1f"\\\\]|\\\\(?:["/\\\\bfnrt]|u[0-9A-Fa-f]{4}))',
                    d = '(?:"' + h + '*")',
                    p = new RegExp("(?:false|true|null|[\\{\\}\\[\\]]|" + f + "|" + d + ")", "g"),
                    m = new RegExp("\\\\(?:([^u])|u(.{4}))", "g"),
                    g = {
                        '"': '"',
                        "/": "/",
                        "\\": "\\",
        ...
        (function(t, i, o, r) {
            e.exports = function() {
                ...
                function a() {
                    function e(e) {
                        for (var t = e.charAt(0).toUpperCase() + e.slice(1), i = (e + " " + R.join(t + " ") + t).split(" "), o = 0; o < i.length; o++)
                ...
                function S(e, t) {
                    ...
                    var r = o("<hours>:<minutes>"),
                        s = o("<hours>:<minutes> am"),
                        a = o("<hours>:<minutes> pm"),
                        c = "24" === t ? 24 : 12,
                        u = i(Math[e > 0 ? "floor" : "ceil"](e / 60), c),
                        l = U.pad(Math.abs(e) % 60, 2);
                ...
                var T, D = n(21),
                    ...
                    j = ["animationend", "animationend", "oanimationend", "webkitAnimationEnd"],
                    U = {
                        contains: e(),
            ...
            e.exports = function() {
                function e(e, t) {
                    ...
                    if ("string" == typeof t) i.add("_", t);
                        ...
                        for (var o in t) t.hasOwnProperty(o) && i.add(o, t[o]);
                    return i;
                }
                                ...
                                o.ensureLoaded(h, function(e) {
                                    ...
                                    if (t == _) {
                                        ...
                                        for (r = 0, s = v.length; r < s; r++) {
                                            a = v[r];
                                            c = w[r].toString();
                                            if (y) a.textContent = c;
                                            else if ("string" == typeof a.innerText) a.innerText = c;
                                            else if ("string" == typeof a.nodeValue) try {
                                                a.data = c;
                                            } catch (e) {}
                                        }
                                        b._active = !0;
                ...
                var g = [],
                    ...
                    E = n.strings;
                if (E)
                    for (var k = 0; k < E.length; k++) e(k, E[k]);
                e.bind = a;
                e.flip = m;
                e.onLanguage = h;
                e.unLanguage = d;
        ...
        (function(t, n, i) {
            e.exports = function() {
                function e(e) {
                    ...
                    if (!o) {
                        var s = this.iframe = document.createElement("iframe"),
                            a = s.style;
            ...
            e.exports = function() {
                ...
                m.fromRefTime = function(e, t, o) {
                    if (f)
                        if (i(this.ref_ts))
                            if (n(e) && e)
                                if (this.from_ref_ts[e]) c(e + " has already been tracked - ignoring");
                                else {
                                    this.from_ref_ts[e] = !0;
                                    var r = +new Date();
                                    r < this.ref_ts ? s() : this.histogram(e, (r - this.ref_ts) / 1e3, t, o);
                                }
                    else c("Event name is not provided or invalid");
                    else c("Global start time has not been set - ignoring");
                };
                ...
                m.end = function(e, t, i) {
                    if (f)
                        if (n(e) && e)
                            if (e in this.start_ts) {
                                var o = +new Date();
                                if (o < this.start_ts[e]) s();
                                else {
                                    this.histogram(e, (o - this.start_ts[e]) / 1e3, t, i);
                                    delete this.start_ts[e];
                                }
                            } else c("Start time of " + e + " has not been set - ignoring");
                    else c("Event name is not provided or invalid");
                };
            ...
            e.exports = function() {
                function e() {
                    var e = window.navigator.userAgent || "",
                        ...
                        o = e || t || window.opera,
                        r = n.test(o) || i.test(o.substr(0, 4));
                    return r;
                }
        ...
        (function(t, i, o, r, s, a, c) {
            e.exports = function() {
                ...
                function l(e) {
                    var t = parseInt(k.getServerTime().toFixed(0), 10),
                        n = t + "";
                ...
                function d() {
                    var e = $.$$("livechat.settings.cookie_law.enabled$bool").getValue(),
                        t = $.$$("livechat.profile.allow_cookies$bool").getValue();
                    return !e || t !== !1;
                }
                ...
                function m(e) {
                    if (!E) {
                        var t = $.$$("livechat.account.key$string").getValue(),
                            n = $.$$("livechat.profile.mid$string").getValue();
                ...
                var $, E, k, S = n(11),
                    ...
                    j = "zlivechatexternallogin_",
                    U = "width=500,height=500,menubar=no,toolbar=no,location=no,personalbar=no,status=no,resizable=yes,scrollbars=no",
                    V = r.extend({
                        init: e,
                        root: $,
                        livechat: P,
        ...
        (function(t, n, i, o, r, s, a, c, u) {
            e.exports = function() {
                ...
                l.getVariable = function(t) {
                    for (var n = a.palettes, i = a.priorities, o = i.length - 1; o >= 0; o--)
                        if (i[o] && n[i[o]] && (n[i[o]][t] || c(n[i[o]][t]))) return e.isVariable.test(n[i[o]][t]) ? l.getVariable(n[i[o]][t].toString().slice(2)) : n[i[o]][t];
                };
                l.reload = function() {
                    l.writeChanges(!0);
                };
        ...
        (function(t, n, i, o, r, s, a, c, u, l, f) {
            e.exports = function() {
                ...
                function m() {
                    ...
                    b = {};
                    for (t in o.palettes)
                        if (o.palettes.hasOwnProperty(t)) {
                            n = u(t, o.priorities);
                            for (e in o.palettes[t])
                                if (o.palettes[t].hasOwnProperty(e) && (isNaN(i[e]) || n > i[e]) && (o.palettes[t][e] || a(o.palettes[t][e]))) {
                                    b[e] = o.palettes[t][e];
                                    i[e] = n;
                                }
                        }
        ...
        (function(t, n) {
            e.exports = function() {
                function e(e, t, n, o) {
                    ...
                    var s = i(e, t);
                    if (s)
                        if (o) s.styleSheet ? s.styleSheet.cssText = n : s[r ? "textContent" : "innerText"] = n;
                        else if (s.styleSheet) s.styleSheet.cssText = [s.styleSheet.cssText, n].join("");
                    else {
                ...
                function i(e, t) {
                    if (t) {
                        ...
                        for (var n = 0, i = e.styleSheets.length; n < i; n++)
                            if ((e.styleSheets[n].ownerNode && e.styleSheets[n].ownerNode.getAttribute("__jx__stylesheet_id") || e.styleSheets[n].owningElement && e.styleSheets[n].owningElement.getAttribute("__jx__stylesheet_id")) == t) return e.styleSheets[n].ownerNode && e.styleSheets[n].ownerNode || e.styleSheets[n].owningElement && e.styleSheets[n].owningElement;
                    }
                }
                var o = {
                        setStyleSheet: e
        ...
        (function(t, n, i) {
            e.exports = function() {
                ...
                var h = t.REGEX,
                    ...
                    p = ["animation", "userSelect", "appearance", "transform", "transformOrigin"],
                    m = {},
                    g = t.join;
        ...
        (function(t, i, o) {
            e.exports = function() {
                ...
                function r(e, t, n) {
                    var i = parseInt(t, 10) || parseInt(d.getServerTime().toFixed(0), 10),
                        o = i + "",
                        r = h.$("livechat").$("profile"),
                        s = p,
                        a = (e.msg || "") + "";
                ...
                function s(e, t) {
                    var n = parseInt(t, 10) || parseInt(d.getServerTime().toFixed(0), 10),
                        i = n + "";
                ...
                function a(e, n) {
                    ...
                    if (t(r)) i(function() {
                        ...
                        var s = d.registerCallback(o),
                            a = "https://" + r.host + g.CALLBACK_FILE_UPLOAD_PATH,
                            c = {
                ...
                function c(e, n) {
                    ...
                    var o = s({
                        ...
                        r = "https://" + i.host + g.FILE_UPLOAD_PATH,
                        a = {
                            ts: o
                        },
                        c = {
                ...
                function u(e) {
                    ...
                    var t = h.$("livechat"),
                        ...
                        r = void 0 === o || o,
                        s = (n.$("allowed_extensions$string").getValue() || "").trim().replace(/\s*,\s*/g, ",").split(","),
                        a = i.$("color_customization_enabled$int").getValue() || i.$("widget_customization_enabled$int").getValue(),
                        c = t.$("profile").$("mid$string").getValue(),
                        u = t.$("profile").$("uid$string").getValue(),
                        l = d.getHost(),
                        f = new window.FormData(),
                        p = [],
                        m = [],
                        v = 0;
                ...
                function l(e, t, n, i, o) {
                    var r = new window.XMLHttpRequest(),
                        s = t + (Object.keys(n).length ? "?" + v.buildQuery(n) : "");
                    if (r.upload) {
                        r.open("POST", s, !0);
        ...
        (function(t, n, i, o) {
            e.exports = function() {
                var e = t("File size too large. Maximum limit is <size>."),
                    r = t("The file you are trying to send is not supported."),
                    s = t("File sending is temporarily disabled. Please try again later."),
                    a = t("<size> bytes"),
                    c = t("<size> KB"),
                    u = t("<size> MB"),
                    l = {};
                ...
                var f = /^(x-|vnd\.)/i,
                    ...
                    d = {},
                    p = t("Failed to send. Please try again.");
                d[l.ERR_SIZE] = e;
                d[l.ERR_FORMAT] = r;
                d[l.ERR_DISABLED] = s;
        ...
        (function(t, n) {
            e.exports = function() {
                ...
                var i = t.isIE ? window.XDomainRequest : !t.isOpera && !t.isAndroid && window.XMLHttpRequest,
                    o = i ? e : null,
                    r = t.isIE ? "//" : "https://";
                e.protocol = "cxhr";
                e.prototype.send = function(e) {
                    ...
                    var r, s = this.url + ["d", +new Date()].join("/"),
                        a = new i(),
                        c = this;
                    a.open("POST", s, !0);
                    a.send(e);
        ...
        (function(t) {
            e.exports = function() {
                function e(e) {
                    var t = new n("wss://" + e + ["c", +new Date()].join("/")),
                        i = this;
        ...
        (function(t, i) {
            e.exports = function() {
                function e(e) {
                    var n = this,
                        i = this.longpoll = new r(!0),
                        o = this.sender = new r(!0);
        ...
        (function(t) {
            e.exports = function() {
                ...
                var o = n(57),
                    r = n(10),
                    s = '<!--# echo var="http_cf_ipcountry" default="geo" -->'.toUpperCase(),
                    a = '<!--# echo var="geoip_country_code" default="geo" -->'.toUpperCase(),
                    c = ".zopim.com",
        ...
        (function(t, i, o) {
            e.exports = function() {
                ...
                c._makeHostList = function() {
                    var e = this,
                        t = r.map(this.cluster_hosts, function(t) {
